...
- [아이템 4. 인스턴스화를 막으려거든 private 생성자를 사용하라.](Effective-java/04_인스턴스화방지_private생성자.md)
- [아이템 5. 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라](Effective-java/05_의존객체주입.md)
- [아이템 6. 불필요한 객체 생성을 피하라](Effective-java/06_불필요한객체생성.md)
- [아이템 7. 다 쓴 객체 잠조를 해제하라](Effective-java/07_다쓴객체참조해제.md)
- [아이템 8. finalizer와 cleaner 사용을 피하라](Effective-java/08_finalizer_cleaner_사용피해라.md)
- [아이템 9. try-finally 보다는 try-with-resources를 사용하라](Effective-java/09_try_with_resources.md)
