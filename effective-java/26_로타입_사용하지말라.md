...
- [아이템 26. 로 타입은 사용하지 말라](#아이템-26-로-타입은-사용하지-말라)
  - [로(raw)타입 이란?](#로raw타입-이란)
  - [로타입 문제점](#로타입-문제점)
      - [로타입 사용](#로타입-사용)
      - [로타입 사용 x](#로타입-사용-x)
  - [로타입(`List`)와 매개변수화 타입(`List<Object>`) 차이점](#로타입list와-매개변수화-타입listobject-차이점)
      - [차이점](#차이점)
      - [타입안정성 예시](#타입안정성-예시)
  - [비한정 와일드 타입 사용하라](#비한정-와일드-타입-사용하라)
      - [Set<?> vs Set 차이](#set-vs-set-차이)
  - [로타입 예외적 사용하는 경우](#로타입-예외적-사용하는-경우)
      - [class 리터럴에는 로 타입을 써야한다.](#class-리터럴에는-로-타입을-써야한다)
