...
- [아이템 02. 생성자에 매개변수가 많다면 빌더를 고려하라.](#아이템-02-생성자에-매개변수가-많다면-빌더를-고려하라)
  - [방법 1. 생성자](#방법-1-생성자)
  - [방법 2. 자바빈즈 패턴(JavaBeans pattern)](#방법-2-자바빈즈-패턴javabeans-pattern)
  - [방법 3. 빌더 패턴 (Builder pattern)](#방법-3-빌더-패턴-builder-pattern)
  - [[실습] Lombok을 이용하여 builder 구현](#실습-lombok을-이용하여-builder-구현)
- [참조](#참조)
