...
- [아이템 42. 익명 클래스보다는 람다를 사용하라](#아이템-42-익명-클래스보다는-람다를-사용하라)
  - [낡은 기법](#낡은-기법)
  - [람다식 (개선ver#1)](#람다식-개선ver1)
      - [타입을 명시해야 코드가 더 명확할 때 제외하고는, 람다의 모든 매개변수 타입은 생략하자.](#타입을-명시해야-코드가-더-명확할-때-제외하고는-람다의-모든-매개변수-타입은-생략하자)
  - [비교자 생성 메서드](#비교자-생성-메서드)
      - [개선ver#2](#개선ver2)
      - [개선ver#3](#개선ver3)
  - [활용 예시 (열거 타입)](#활용-예시-열거-타입)
      - [아이템34 예시 코드](#아이템34-예시-코드)
      - [람다 사용 ver](#람다-사용-ver)
      - [주의사항 (아래 같은 경우는 상수별 클래스 몸체 사용)](#주의사항-아래-같은-경우는-상수별-클래스-몸체-사용)
  - [람다로 대체할 수 없는 곳](#람다로-대체할-수-없는-곳)
      - [추상 클래스의 인스턴스를 만들 때는 익명 클래스 써야함.](#추상-클래스의-인스턴스를-만들-때는-익명-클래스-써야함)
      - [추상 메서드가 여러 개인 인터페이스의 인스턴스 만들때는 익명 클래스 써야함](#추상-메서드가-여러-개인-인터페이스의-인스턴스-만들때는-익명-클래스-써야함)
      - [람다는 자신을 참조할 수 없다.](#람다는-자신을-참조할-수-없다)
