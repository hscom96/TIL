...
- [아이템 89. 인스턴스 수를 통제해야 한다면 readResolve 보단는 열거 타입을 사용하라](#아이템-89-인스턴스-수를-통제해야-한다면-readresolve-보단는-열거-타입을-사용하라)
  - [싱글턴일까?](#싱글턴일까)
  - [`readResolve` 메서드](#readresolve-메서드)
  - [해결책은 열거 타입](#해결책은-열거-타입)
  - [참조](#참조)
