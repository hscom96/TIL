...
- [아이템 50. 적시에 방어적 복사본을 만들라](#아이템-50-적시에-방어적-복사본을-만들라)
  ...
  - [결론](#결론)
  - [주의사항](#주의사항)
      - [방어적 복사에는 성능 저하가 따른다.](#방어적-복사에는-성능-저하가-따른다)
      - [호출자가 컴포넌트 내부를 수정하지 않으리라 확신하면 방어적 복사를 생략할 수 있다.](#호출자가-컴포넌트-내부를-수정하지-않으리라-확신하면-방어적-복사를-생략할-수-있다)
      - [방어적 복사를 생략해도 될때는?](#방어적-복사를-생략해도-될때는)
