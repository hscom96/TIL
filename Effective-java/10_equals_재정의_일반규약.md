...
- [아이템 10. equals는 일반 규약을 지켜 재정의하라](#아이템-10-equals는-일반-규약을-지켜-재정의하라)
  - [equals 재정의 안해도 괜찮은 경우는?](#equals-재정의-안해도-괜찮은-경우는)
  - [equals 일반 규약](#equals-일반-규약)
    - [1. 반사성 (reflexivity)](#1-반사성-reflexivity)
    - [2. 대칭성 (symmetry)](#2-대칭성-symmetry)
      - [잘못된 코드](#잘못된-코드)
      - [정상 코드](#정상-코드)
    - [3. 추이성 (transitivity)](#3-추이성-transitivity)
      - [__문제 코드 #1 (대칭성 위배)__](#문제-코드-1-대칭성-위배)
      - [__문제 코드 #2 (추이성 위배)__](#문제-코드-2-추이성-위배)
      - [__즉, 구체 클래스를 확장해 새로운 값을 추가하면서 equals 규약을 만족시킬 방법은 존재하지 않는다.__](#즉-구체-클래스를-확장해-새로운-값을-추가하면서-equals-규약을-만족시킬-방법은-존재하지-않는다)
      - [__문제 코드 #3 (리스코프 치환 원칙 위배)__](#문제-코드-3-리스코프-치환-원칙-위배)
      - [우회 방법](#우회-방법)
    - [4. 일관성 (consistency)](#4-일관성-consistency)
    - [5. null 아님](#5-null-아님)
  - [equals 올바른 구현 방법](#equals-올바른-구현-방법)
  - [주의 사항](#주의-사항)
  - [용어 정리](#용어-정리)
      - [표준형? canonical form?](#표준형-canonical-form)
