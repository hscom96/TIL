...
- [아이템 39. 명명 패턴보다 애너테이션을 사용하라](#아이템-39-명명-패턴보다-애너테이션을-사용하라)
  - [명명패턴](#명명패턴)
    - [단점](#단점)
      - [오타가 나면 안된다.](#오타가-나면-안된다)
      - [올바른 프로그램 요소에서만 사용되리라 보증할 방법 없다.](#올바른-프로그램-요소에서만-사용되리라-보증할-방법-없다)
      - [프로그램 요소를 매개변수로 전달할 마땅한 방법이 없다.](#프로그램-요소를-매개변수로-전달할-마땅한-방법이-없다)
  - [애너테이션](#애너테이션)
  - [marker 애너테이션](#marker-애너테이션)
    - [사용 프로그램](#사용-프로그램)
    - [처리 프로그램](#처리-프로그램)
  - [매개변수 하나를 받는 애너테이션 타입](#매개변수-하나를-받는-애너테이션-타입)
    - [사용 프로그램](#사용-프로그램-1)
    - [처리 프로그램](#처리-프로그램-1)
  - [배열 매개변수를 받는 애너테이션 타입](#배열-매개변수를-받는-애너테이션-타입)
    - [사용 프로그램](#사용-프로그램-2)
    - [처리 프로그램](#처리-프로그램-2)
  - [반복 가능한 애너테이션 타입](#반복-가능한-애너테이션-타입)
    - [주의할점](#주의할점)
    - [사용 프로그램](#사용-프로그램-3)
    - [처리 프로그램](#처리-프로그램-3)
